      ...
      <div className="blogs grid lg:grid-cols-2 2xl:grid-cols-3 gap-8 ">
        ...
        {stories.map((blog:any) => (
          ...
          <div className="button">
            <Link href={"/blogs/" + blog.slug.current}><button className='bg-[#ee4818] hover:bg-[#0f0f0f] border-[0.02px] border-[#ee4818] hover:border-[#646464] text-[#d3d3d3] px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-5 xl:px-6 xl:py-4 2xl:px-8 2xl:py-5 mb-2 text-xs 2xl:text-sm'>Read More</button></Link>  
          </div>
        </div>
        ))}
      </div>
        <div className='flex justify-center w-full my-16'>
          <Link href="/blogs"><button className='bg-[#ee4818] hover:bg-[#0f0f0f] hover:border-[0.02px] hover:border-[#646464] text-[#d3d3d3] text-sm py-5 px-8 rounded-sm '>
            See All Blogs
            </button></Link>
          </div>
      </div>
